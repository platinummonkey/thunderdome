...
class SpecParserTest(BaseThunderdomeTestCase):
    ...
    def test_should_return_correct_gremlin_for_property(self):
        ...
        self.assertEqual(prop.gremlin, expected)
    ...
    def test_should_return_correct_gremlin_for_edge(self):
        ...
        self.assertEqual(edge.gremlin, expected)
    ...
    def test_should_return_correct_gremlin_for_key_index_creation(self):
        ...
        self.assertEqual(key_index.gremlin, expected)

    def test_should_return_appropriate_type(self):
        """Should return appropriate type when parsing a statement"""
        self.assertIsInstance(self.spec_parser.parse_statement(self.edge_spec), Edge)
        self.assertIsInstance(self.spec_parser.parse_statement(self.property_spec), Property)
    ...
    def test_should_return_none_for_defaults(self):
        ...
        self.assertNotIn('property', self.spec_parser._defaults)
        self.assertIsNone(self.spec_parser.parse_statement(default_spec))
        self.assertIn('property', self.spec_parser._defaults)
        self.assertIn('functional', self.spec_parser._defaults['property']._values)
